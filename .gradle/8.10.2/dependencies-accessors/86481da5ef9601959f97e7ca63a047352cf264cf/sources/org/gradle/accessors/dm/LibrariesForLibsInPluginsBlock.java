...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Group of libraries at <b>hilt.kapt</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public HiltKaptLibraryAccessors getKapt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForHiltKaptLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class HiltKaptLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hiltKpatCompiler</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("hilt.kapt.compiler");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>databindingRuntime</b> with value <b>8.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltKpatCompiler</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHiltKpatCompiler() { return getVersion("hiltKpatCompiler"); }

        /**
         * Version alias <b>hiltPlugin</b> with value <b>2.48.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kasp</b> with value <b>1.9.23-1.0.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKasp() { return getVersion("kasp"); }
        ...
        /**
         * Version alias <b>mlKitFaceDetection</b> with value <b>17.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>orgJetbrainsKotlinAndroid</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOrgJetbrainsKotlinAndroid() { return getVersion("orgJetbrainsKotlinAndroid"); }
    ...
    public static class DevtoolsPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>kasp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
    ...
    public static class OrgJetbrainsKotlinPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>orgJetbrainsKotlinAndroid</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
